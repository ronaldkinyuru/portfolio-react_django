...
function LogoComponent () {
             return(
                ...
                <div>
                <Card style={{height:100, width:1900}}>
                ...
                title="image"
                />   
               <CardMedia style={{height:40,width:40, marginLeft:400, color:'green',marginTop:30, textDecoration:'bold'}} 
               component="img"
               alt="image"
            
               image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReoLBmKygPsPKZxmLCBLSX3RTjEdK1v4I6CkzpKAunDA&s"
               title="image"
               />
               <Typography style={{color:'#C00100', marginTop:40, marginLeft:20, fontSize:'large'}}>APPROVED BOOKINGS</Typography>
               <Typography  style={{color:'#1E99C0', marginTop:40, marginLeft:600}}>8/04/2024</Typography>
